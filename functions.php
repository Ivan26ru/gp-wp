...
function meta_arr($meta_name){ //Функция для вывода массива по ключу произвольных полей
	...
	function meta_teg($teg,$teg_title,$teg_class,$title,$name){//функция выбора всех значений метатегов по названию и помещение их в определенный список. переменные: теги в которые будет помещено значение,оборачивающий тег title, название категории, значение категории. <li class="$teg_class"><span>Телефон:</span> 777</li>
